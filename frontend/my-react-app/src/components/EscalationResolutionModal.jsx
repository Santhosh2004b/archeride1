// frontend/my-react-app/src/components/EscalationResolutionModal.jsx
            ...
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-md overflow-hidden animate-scaleIn">
                ...
                <div className="p-6 space-y-4">
                    <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 text-sm text-blue-700">
                        ...
                        The admin will be notified only after you upload the required proof of resolution (PDF, Excel, Word).
                    </div>
                    ...
                    <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:bg-gray-50 transition-colors relative">
                        ...
                        <div className="flex flex-col items-center gap-2 pointer-events-none">
                            ...
                            <span className="text-xs text-gray-400">Supported: PDF, Excel, CSV, Word</span>
                        </div>
                    </div>
                            ...
                            {files.map((f, i) => (
                                <div key={i} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg border border-gray-100">
                                    <div className="flex items-center gap-3">
                                        <FilePdf size={20} className="text-red-500" /> {/* Generic Icon */}

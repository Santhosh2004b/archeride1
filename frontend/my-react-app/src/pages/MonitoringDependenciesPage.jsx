...
const MonitoringDependenciesPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 className="font-marcellus text-2xl sm:text-3xl font-bold text-gray-900">Dependencies</h1>
          <p className="text-xs sm:text-sm text-gray-500 mt-1">Table — Latest Updates</p>
          <p className="text-xs text-gray-400 mt-1">Track project dependencies and their relationships with real-time status updates.</p>
        </div>
      </motion.div>
